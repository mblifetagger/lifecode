...
var QRCode = /** @class */ (function (_super) {
    ...
    QRCode.prototype.generateRGBKey = function (uuid) {
        var hash = Array.from(uuid).reduce(function (acc, char) { return acc + char.charCodeAt(0); }, 0);
    ...
    ;
    QRCode.prototype.getRGBKey = function () {
        return rgbKey;
    };
    ;
    ...
    QRCode.prototype.update = function () {
        var _a = this.props, value = _a.value, ecLevel = _a.ecLevel, enableCORS = _a.enableCORS, size = _a.size, quietZone = _a.quietZone, bgColor = _a.bgColor, fgColor = _a.fgColor, logoImage = _a.logoImage, logoWidth = _a.logoWidth, logoHeight = _a.logoHeight, logoOpacity = _a.logoOpacity, removeQrCodeBehindLogo = _a.removeQrCodeBehindLogo, qrStyle = _a.qrStyle, eyeRadius = _a.eyeRadius, eyeColor = _a.eyeColor, authenticated = _a.authenticated;
        ...
        if (authenticated && value.includes('uuid')) {
            ...
            var color = "rgba(".concat(r, ", ").concat(g, ", ").concat(b, ", 0.99)"); // near-invisible to human eye
